        ...
        <div id="kt_aside_menu" data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500" class="kt-aside-menu kt-scroll ps ps--active-y" style="height: 344px; overflow: hidden">
            <ul class="kt-menu__nav">
                <li aria-haspopup="true" class="kt-menu__item">
                    <a href="" class="kt-menu__link"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li aria-haspopup="true" class="kt-menu__item">
                    <a href="/register/dang-ky-bao-hiem-y-te" class="kt-menu__link"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" width="96" height="96" fill="currentColor" viewBox="0 0 16 16" id="IconChangeColor" class="bi bi-file-earmark-medical">
