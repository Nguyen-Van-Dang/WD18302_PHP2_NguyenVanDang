<div id="kt_aside" class="kt-aside kt-aside--fixed kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" style="opacity: 1">
    ...
    <div id="kt_aside_menu_wrapper" class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid">
        <div id="kt_aside_menu" data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500" class="kt-aside-menu kt-scroll ps ps--active-y" style="height: 344px; overflow: hidden">
            <ul class="kt-menu__nav">
                <li class="kt-menu__item">
                    <a href="" class="kt-menu__link"><span class="kt-menu__link-icon"><svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li data-ktmenu-submenu-toggle="hover" class="kt-menu__item kt-menu__item--submenu">
                    <a href="" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <li data-ktmenu-submenu-toggle="hover" class="kt-menu__item kt-menu__item--submenu">
                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <rect x="0" y="0" width="24" height="24"></rect>
                ...
                <li class="kt-menu__item">
                    <a href="" class="kt-menu__link"><span class="kt-menu__link-icon"><svg width="96" height="96" fill="currentColor" viewBox="0 0 16 16" id="IconChangeColor" class="bi bi-file-earmark-medical">
                                <path d="M7.5 5.5a.5.5 0 0 0-1 0v.634l-.549-.317a.5.5 0 1 0-.5.866L6 7l-.549.317a.5.5 0 1 0 .5.866l.549-.317V8.5a.5.5 0 1 0 1 0v-.634l.549.317a.5.5 0 1 0 .5-.866L8 7l.549-.317a.5.5 0 1 0-.5-.866l-.549.317V5.5zm-2 4.5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5zm0 2a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5z" id="mainIconPathAttribute"></path>
                                <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2zM9.5 3A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5v2z" id="mainIconPathAttribute"></path>
                            </svg></span>
