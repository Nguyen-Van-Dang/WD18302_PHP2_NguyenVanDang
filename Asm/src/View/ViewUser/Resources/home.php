      ...
      <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
        <div id="kt_aside" class="kt-aside kt-aside--fixed kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop"
          ...
          <div id="kt_aside_menu_wrapper" class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid">
            <div id="kt_aside_menu" data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500"
              class="kt-aside-menu kt-scroll ps ps--active-y" style="height: 344px; overflow: hidden">
              <ul class="kt-menu__nav">
                <li aria-haspopup="true" class="kt-menu__item">
                  <a href="" class="kt-menu__link"><span class="kt-menu__link-icon"><svg
                    ...
                    <span class="kt-menu__link-text">Thông báo và tin tức</span></a>
                </li>
                <li aria-haspopup="true" class="kt-menu__item">
                  <a href="" class="kt-menu__link"><span class="kt-menu__link-icon"><svg
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                ...
                <li aria-haspopup="true" data-ktmenu-submenu-toggle="hover"
                  ...
                  <a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                        height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <ul class="kt-menu__subnav">
                      <li aria-haspopup="true" class="kt-menu__item">
                        <a href="#" class="kt-menu__link"><i
                          ...
                          <span class="kt-menu__link-text">Thay đổi lịch học</span></a>
                      </li>
                      <li aria-haspopup="true" class="kt-menu__item">
                        <a href="#" class="kt-menu__link"><i
                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                          <span class="kt-menu__link-text">Lịch học</span></a>
                      </li>
                      <li aria-haspopup="true" class="kt-menu__item">
                        <a href="#" class="kt-menu__link"><i
                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                          <span class="kt-menu__link-text">Lịch thi</span></a>
                      </li>
                    </ul>
                  </div>
                </li>
                  ...
                  <div class="kt-menu__submenu">
                    ...
                    <ul class="kt-menu__subnav">
                      <li aria-haspopup="true" class="kt-menu__item kt-menu__item--parent">
                        <span class="kt-menu__link"><span class="kt-menu__link-text">Điểm</span></span>
                      </li>
                      <li aria-haspopup="true" class="kt-menu__item">
                        <a href="#" class="kt-menu__link"><i
                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                          <span class="kt-menu__link-text">Bảng điểm theo kỳ</span></a>
                      </li>
                      <li aria-haspopup="true" class="kt-menu__item">
                        <a href="#" class="kt-menu__link"><i
                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                          <span class="kt-menu__link-text">Lịch sử học</span></a>
                      </li>
                      <li aria-haspopup="true" class="kt-menu__item">
                        <a href="#" class="kt-menu__link"><i
                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                          <span class="kt-menu__link-text">Bảng điểm</span></a>
                      </li>
                    </ul>
                  </div>
                </li>
                <li aria-haspopup="true" class="kt-menu__item">
                  <a href="#" class="kt-menu__link"><span class="kt-menu__link-icon"><svg
                    ...
                    <span class="kt-menu__link-text">Khen thưởng/Kỷ luật</span></a>
                </li>
                <li aria-haspopup="true" class="kt-menu__item">
                  <a href="#" class="kt-menu__link"><span class="kt-menu__link-icon"><svg
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                    ...
                    <span class="kt-menu__link-text">Học phí</span></a>
                </li>
                <li aria-haspopup="true" data-ktmenu-submenu-toggle="hover"
                  class="kt-menu__item kt-menu__item--submenu">
                  <a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg
                  ...
                  <div class="kt-menu__submenu">
                    ...
                    <ul class="kt-menu__subnav">
                      <li aria-haspopup="true" class="kt-menu__item">
                        <a href="#" class="kt-menu__link"><i
                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                          <span class="kt-menu__link-text">Đăng ký dịch vụ</span></a>
                      </li>
                      <li aria-haspopup="true" class="kt-menu__item">
                        <a href="#" class="kt-menu__link"><i
                            class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                          <span class="kt-menu__link-text">Dịch vụ đã đăng ký</span></a>
                      </li>
                    </ul>
                  </div>
                </li>
                <li aria-haspopup="true" class="kt-menu__item">
                  <a href="#" class="kt-menu__link"><span class="kt-menu__link-icon"><svg
                    ...
                    <span class="kt-menu__link-text">SMS</span></a>
                </li>
                <li aria-haspopup="true" class="kt-menu__item">
                  <a href="/register/dang-ky-bao-hiem-y-te" class="kt-menu__link"><span class="kt-menu__link-icon"><svg
                        xmlns="http://www.w3.org/2000/svg" width="96" height="96" fill="currentColor"
                        viewBox="0 0 16 16" id="IconChangeColor" class="bi bi-file-earmark-medical">
                        <path
                    ...
                    <span class="kt-menu__link-text">Đăng ký bảo hiểm y tế</span></a>
                </li>
                <li aria-haspopup="true" class="kt-menu__item">
                  <a href="#" class="kt-menu__link"><span class="kt-menu__link-icon"><img
                        src="https://img.icons8.com/office/16/000000/help.png" /></span>
              ...
              <div class="ps__rail-y" style="top: 0px; height: 344px; right: 3px">
        ...
        <div id="kt_wrapper" class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper">
          <div id="kt_header" class="kt-header kt-grid__item kt-header--fixed">
            ...
            <div class="kt-header__topbar">
              <a href="#" title="Đổi màu"
                class="kt-header__topbar-item kt-header__topbar-item--langs">
                <div class="kt-header__topbar-wrapper">
                  <span class="kt-header__topbar-icon"><svg xmlns="http://www.w3.org/2000/svg"
              ...
              <div class="kt-header__topbar-item kt-header__topbar-item--user">
                ...
                <div
                  ...
                  <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="
                        background-image: url('https://ap.poly.edu.vn/theme/student_v2/media/misc/bg-1.jpg');
                      ">
                    <div class="kt-user-card__avatar"></div>
                    <div class="kt-user-card__name">Nguyễn Văn Đặng</div>
                  </div>
          ...
          <div id="kt_content" class="kt-content kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
            ...
            <div class="kt-container kt-container--fluid kt-grid__item kt-grid__item--fluid">
              ...
              <button type="button" data-toggle="modal" data-target="#showNotiForStudent"
                class="d-none btn btn-primary show-noti-student">
              </button>
              <div id="showNotiForStudent" tabindex="-1" role="dialog" aria-labelledby="showNotiForStudentLabel"
          ...
          <div id="kt_footer" class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
            <div class="kt-container kt-container--fluid">
              <div class="footer-filter-by-campus" style="display: flex; flex-direction: column;justify-items: center;align-items: center; margin: 0 auto;">
                  <img id="poly-logo" src="../Asm/src/Public/img/logo.png" width="250" />
                  <h6 class="kt-widget1__title">
